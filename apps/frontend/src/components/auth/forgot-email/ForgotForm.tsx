		...
		<div className="min-h-screen flex items-center justify-center  from-pink-100 via-pink-200 to-pink-300">
			...
			>
				<div className="flex flex-col items-center mb-2">
					...
					<h2 className="text-2xl font-bold text-pink-600 mb-1">Forgot Password?</h2>
					<p className="text-pink-400 text-sm text-center">Enter your email and we'll send a 5-digit verification code instantly.</p>
				</div>
				<div>
