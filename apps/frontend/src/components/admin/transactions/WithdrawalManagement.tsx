              ...
              {withdrawals.map((withdrawal) => (
                <tr key={withdrawal._id} className="hover:bg-blue-50 transition-colors">
                  ...
                  <td className="px-2 py-3">
                    ...
                    <div className="text-xs text-gray-500">{withdrawal.transactionIds.length || 0} txns</div>
                    {withdrawal.reference && (
                      <div className="text-xs text-blue-600 truncate">Ref: {withdrawal.reference.slice(0,8)}</div>
                    )}
                  </td>
                  <td className="px-2 py-3">
                    <div className="flex items-center gap-2">
                      ...
                      <div className="min-w-0 flex-1">
                        ...
                        {withdrawal.muaLocation && (
                          <div className="text-xs text-gray-400 truncate">{withdrawal.muaLocation}</div>
                        )}
                      </div>
                    </div>
                  </td>
                    ...
                    {withdrawal.bankInfo ? (
                      <div className="flex items-center gap-1">
                        ...
                        <div className="min-w-0 flex-1">
                          ...
                          <div className="text-xs text-gray-400 truncate">{withdrawal.bankInfo.accountName}</div>
                        </div>
                      </div>
                    ) : (
                      <div className="text-xs text-gray-400">No bank info</div>
                    )}
                  </td>
                  <td className="px-2 py-3">
                  ...
                  <td className="px-2 py-3 text-xs text-gray-500">
                    <div className="truncate">
                      Req: {formatDate(withdrawal.requestedAt)}
