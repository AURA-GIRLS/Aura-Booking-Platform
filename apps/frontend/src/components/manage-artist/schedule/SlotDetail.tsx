   ...
   <div className="w-1/3 flex flex-col">
          <div className="flex-1 p-6">
            <Card className="border-pink-200">
              ...
              <CardContent className="px-6 space-y-4">
                <div>
                  <h3 className="font-semibold text-pink-700">Interactive Calendar</h3>
                  <p className="text-sm text-pink-400">Drag slots to reschedule</p>
                </div>
                <Separator />
                <div className="space-y-2">
                  <div className="text-sm font-medium mb-2">Slot Types:</div>
                  <div className="space-y-1">
                    ...
                    <div className="flex items-center gap-2">
                      ...
                      <span className="text-xs">Original Working</span>
                    </div>
                    <div className="flex items-center gap-2">
                      <div className="w-3 h-3 rounded" style={{ background: "#10B981" }}></div>
                      <span className="text-xs">New Working</span>
                    </div>
                    <div className="flex items-center gap-2">
                ...
                <div>
                  ...
                  <p className="text-sm text-pink-400">
                    Click and drag any slot to reschedule. Slots will snap to 15-minute intervals.
                  </p>
                </div>
              </CardContent>
              <CardFooter>
                <div className="flex gap-2 w-full">
                  <Button
                    variant="outline"
                    className="flex-1 border-pink-300 text-pink-500 hover:bg-pink-100 bg-transparent"
                  >
          ...
          <div className="border-t bg-pink-100 p-6 rounded-br-lg">
            <div className="mb-4 flex items-center justify-between">
              ...
              <Badge className="bg-pink-200 text-pink-700 border-pink-300" variant="secondary">
                3 New
              </Badge>
            </div>
              ...
              <Card className="p-4 border-pink-200">
                ...
                <div className="flex gap-2">
                  ...
                  <Button
                    variant="outline"
                    size="sm"
                    className="flex-1 h-8 text-xs border-pink-300 text-pink-500 hover:bg-pink-100 bg-transparent"
                  >
