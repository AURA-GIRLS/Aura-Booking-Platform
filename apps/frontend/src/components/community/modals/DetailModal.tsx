                ...
                <DialogHeader className="px-4 py-3 border-b">
                    <div className="flex items-center justify-between">
                        <div className="flex items-center space-x-2">
                            ...
                            {isAuthenticated() && post.authorId !== _currentUser?._id && (
                                <div className="flex items-center space-x-2 pr-3">
                                    ...
                                    >
                                        {(() => {
                                            ...
                                            return following[post.authorId] ? 'Following' : 'Follow';
                                        })()}
                                    </button>
                                            ...
                                            <div className="ml-auto">
                                                <DropdownMenu>
                                                    ...
                                                    <DropdownMenuContent align="end" className="w-44 bg-white rounded-xl shadow-lg py-2 z-50 border border-pink-100">
                                                        ...
                                                        <DropdownMenuItem
                                                            className="text-rose-600 cursor-pointer focus:bg-rose-100"
                                                            onClick={() => checkAuthAndExecute(async () => { alert('Comment reported'); })}
                                                        >
                                                            Report
                                                        </DropdownMenuItem>
                                                    </DropdownMenuContent>
                                                                    ...
                                                                    <div className="ml-auto">
                                                                        <DropdownMenu>
                                                                            ...
                                                                            >
                                                                                ...
                                                                                <DropdownMenuItem
                                                                                    className="text-rose-600 cursor-pointer focus:bg-rose-100"
                                                                                    onClick={() => checkAuthAndExecute(async () => { alert('Reply reported'); })}
                                                                                >
                                                                                    Report
                                                                                </DropdownMenuItem>
                                                                            </DropdownMenuContent>
